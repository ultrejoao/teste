                                                ...
                                                <ul>
                                                    <li class="product-item gap14 mb-10">
                                                        ...
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                                <a href="{{ asset('product-list.html')}}" class="body-text">Dog Food
                                                    ...
                                                    <li class="product-item gap14 mb-10">
                                                        ...
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                                <a href="{{ asset('product-list.html')}}" class="body-text">Natural
                                                    ...
                                                    <li class="product-item gap14">
                                                        ...
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                                <a href="{{ asset('product-list.html')}}" class="body-text">Freshpet
                                            ...
                                            <li>
                                                <ul>
                                                    <li class="product-item gap14 mb-10">
                                                        ...
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                                <a href="{{ asset('product-list.html')}}" class="body-text">Sojos
                                                    ...
                                                    <li class="product-item gap14 mb-10">
                                                        ...
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                                <a href="{{ asset('product-list.html')}}" class="body-text">Kristin
                                                                    Watson</a>
                                                            </div>
                                                        </div>
                                                    </li>
                                                    ...
                                                    <li class="product-item gap14 mb-10">
                                                        ...
                                                        <div class="flex items-center justify-between gap20 flex-grow">
                                                            <div class="name">
                                                                <a href="{{ asset('product-list.html')}}" class="body-text">Mega
                                                                    Pumpkin Bone</a>
                                                            </div>
                                                        </div>
                                                    </li>
                                ...
                                <div class="popup-wrap message type-header">
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end has-content"
                                            ...
                                            <li><a href="{{ asset('#')}}" class="tf-button w-full">View all</a></li>
                                        </ul>
                                    </div>
                                </div>
